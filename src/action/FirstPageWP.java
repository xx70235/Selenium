...
public class FirstPageWP {
	...
	public FirstPageWP(WebDriver driver, CardModel model) {
		...
		if (SBrowserSwing.baseUrl.equals("null")) {
			SBrowserSwing.baseUrl = "http://www.selectyourgoods.com";
		}
	}
	...
	public void emuAction() throws Exception {
		...
		// WebElement element =
		// wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'https://signup.wpengine.com/?plan_id=personal&coupon=')]")));
		// element.click();
		...
		driver.findElement(By.id("form_password")).sendKeys(
				cardModel.getPassword());
		driver.findElement(By.id("form_confirm_password")).clear();
		driver.findElement(By.id("form_confirm_password")).sendKeys(
				cardModel.getPassword());
		driver.findElement(By.id("form_account_name")).clear();
		driver.findElement(By.id("form_account_name")).sendKeys(
